  ...
  "All States": [
    {
      ...
      eligibility: "All homeowners who purchase solar",
      expires: "2032 (phases to 26% in 2033)",
    },
    {
      name: "ENERGY STAR Home Improvement Credit",
      type: "Federal",
      amount: "Up to $3,200/year",
      eligibility: "ENERGY STAR certified windows, HVAC, insulation",
      expires: "Through 2032",
    },
    {
      name: "High-Efficiency Electric Home Rebate (HEEHRA)",
      type: "Federal",
      amount: "Up to $14,000",
      eligibility: "Income-qualified households for heat pumps, EVs, weatherization",
      expires: "Ongoing",
    },
  ],
  California: [
