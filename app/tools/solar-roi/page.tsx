    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-yellow-500 to-orange-500 py-12 px-4 text-white text-center">
        ...
        <p className="text-yellow-100 text-sm max-w-xl mx-auto">
          Calculate your exact solar investment return, payback period, and 25-year savings based on your state and usage.
        </p>
      </div>
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      { label: "Federal Tax Credit (30%)", value: `-$${federalCredit.toLocaleString(undefined, { maximumFractionDigits: 0 })}`, highlight: true },
                      { label: "Net Cost After Credits", value: `$${netCost.toLocaleString(undefined, { maximumFractionDigits: 0 })}` },
                    ].map((r) => (
