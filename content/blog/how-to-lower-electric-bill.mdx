...
faq:
  - q: "What uses the most electricity in a home?"
    a: "Heating and cooling accounts for 43% of the average home's electricity usage. Water heating is second at 18%, followed by appliances (15%), lighting (10%), and electronics (7%). Targeting HVAC and water heating delivers the most significant bill reductions."
  - q: "How much can I realistically reduce my electric bill?"
    a: "Most homeowners can reduce their electricity bill 20–40% through a combination of behavioral changes, smart thermostats, LED lighting, and appliance upgrades — without major capital investments. Solar panels can offset 80–100% of remaining usage."
  - q: "Does unplugging devices really save electricity?"
    a: "Phantom load (standby power) accounts for roughly 10% of household electricity usage. Unplugging TVs, cable boxes, and electronics you don't use daily can save $100–$200/year. Smart power strips make this easier by cutting power to peripherals when the main device is off."
  - q: "What temperature should I set my thermostat to save money?"
    a: "The DOE recommends 78°F when home in summer, 85°F when away, and 68°F when home in winter, 60°F when sleeping or away. A programmable or smart thermostat that automates these adjustments can save $180/year or more."
  - q: "How much does a smart thermostat save?"
    a: "Smart thermostats save an average of $131–$180 per year, per the EPA and manufacturers. Google Nest and Ecobee models typically pay for themselves within 18 months. Savings are higher in homes with older, manual thermostats and extreme seasonal temperature swings."
  - q: "Is solar a good way to lower electric bills?"
    a: "Solar is the most impactful long-term strategy to lower electricity costs, potentially eliminating 80–100% of your electricity bill. The 30% federal tax credit, falling panel costs, and rising utility rates have made solar financially compelling in most US states."
---
...
Before implementing any strategy, it helps to understand where your bill comes from. Your utility bill has several components:

**Energy charge (kWh):** The biggest line item — the cost of electricity you actually use. Typically 60–80% of the bill.

**Demand charge:** Some utilities (especially commercial) charge for peak demand. Residential demand charges are rare but growing in some markets — check your rate schedule.

**Fixed charges:** Service fees that don't change regardless of usage — typically $10–$25/month. These can't be reduced by conservation.

**Time-of-use (TOU) rates:** If your utility uses TOU pricing, the rate you pay changes by time of day and season. Electricity during peak hours (typically 4–9 PM weekdays in summer) can cost 2–4× the off-peak rate. Shifting usage to off-peak hours is one of the highest-ROI free strategies available.

**How to read your bill for savings opportunities:**
1. Check your rate schedule — is TOU pricing available or mandatory?
2. Compare year-over-year kWh usage — is consumption increasing without a lifestyle change?
3. Look for the billing period peak demand if shown
4. Check for any voluntary programs (demand response, budget billing) that could offer savings

Understanding your specific rate structure tells you which strategies have the most impact for your situation.
